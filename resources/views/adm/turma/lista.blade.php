                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <a href="#" class="active"><i class="fa fa-group fa-fw"></i> Turmas</a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">
                            Listagem de turmas
                            <a href="./adicionar" class="btn btn-primary pull-right">Adicionar turma</a>
                        </h3>
                        <div class="row">
                            <div class="col-lg-12">
                                @if(session('msg'))
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                @foreach($turmas as $turma)
                                                    <tr>
                                                        <td>{{$turma->id}}</td>
                                                        <td>{{$turma->name}}</td>
                                                        <td>{{$turma->curso->name }}</td>
                                                        <td align="center">
                                                            <a href="/admin/turma/{{ $turma->id }}"
                                                               class="btn btn-info btn-circle"
                                                               data-toggle="tooltip" data-placement="bottom"
                                                               title="Editar">
                                                                <i class="fa fa-pencil"></i></a>
                                                            <a
                                                                href="/admin/turma/delete/{{$turma->id}}"
