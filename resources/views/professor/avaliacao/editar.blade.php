                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" name="datestart"
                                                               value="{{date('Y-m-d', strtotime($avaliacao->data_inicio))}}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="turma_id">
                                                            @foreach($turmas as $turma)
                                                                <option
                                                                    {{$avaliacao->turma_id == $turma->id ? 'selected' : ''}} value="{{$turma->id}}">{{$turma->name}}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="disciplina_id">
                                                            @foreach($disciplinas as $disciplina)
                                                                <option
                                                                    {{$avaliacao->disciplina_id == $disciplina->id ? 'selected' : ''}} value="{{$disciplina->id}}">{{$disciplina->name}}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
