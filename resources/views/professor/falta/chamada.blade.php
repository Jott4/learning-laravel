                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">
                            Realizar chamada
                            <a href="turma.html" class="btn btn-default pull-right">Voltar</a>
                        </h3>
                        <div class="row">
                            <div class="col-lg-12">
                                        ...
                                        <form action="#">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        <th>Aluno</th>
                                                        <th class="center width-100">Presença</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="td_200">
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input type="checkbox" value="">Presente
                                                                </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <a href="turma.html" class="btn btn-default">Cancelar</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
